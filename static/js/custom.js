...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
       center: {lat: 51.13592, lng: 71.46545},
...
var love = setInterval(function(){
  ...
  $('.bg_heart').append("<div class='heart' style='width:"+r_size+"px;height:"+r_size+"px;left:"+r_left+"%;background:rgba(14,"+(r_bg-25)+","+r_bg+",1);-webkit-animation:love "+r_time+"s ease;-moz-animation:love "+r_time+"s ease;-ms-animation:love "+r_time+"s ease;animation:love "+r_time+"s ease'></div>");
